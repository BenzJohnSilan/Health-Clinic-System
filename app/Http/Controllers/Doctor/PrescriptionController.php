...
class PrescriptionController extends Controller
{
    public function store(Request $request)
    {
        ...
        if ($isManual) {
            ...
            return back()->with('success', 'Manual prescription added successfully!');
        }
        ...
        if ($medicine->quantity < $request->quantity_prescribed) {
            return back()->with('error', 'Not enough stock for this medicine!');
        }
    ...
    public function destroy(Prescription $prescription)
    {
        ...
        if ($prescription->medicine_id) {
            ...
            if ($medicine) {
                $medicine->quantity += $prescription->quantity_prescribed;
