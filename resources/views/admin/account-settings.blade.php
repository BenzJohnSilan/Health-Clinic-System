    ...
    <div class="settings-container">
        ...
        <div class="settings-sidebar">
            ...
            <div class="profile-card">
                ...
                <form action="{{ route('admin.profile.avatar.update') }}"
                    ...
                    <div class="avatar-wrapper" id="avatarPreviewWrapper" onclick="document.getElementById('avatarInput').click()">
                        @if($admin->avatar && file_exists(storage_path('app/public/' . $admin->avatar)))
                            <img src="{{ asset('storage/'.$admin->avatar) }}" alt="Avatar" id="avatarPreview">
                        @else
                ...
                @if($admin->avatar)
                <form action="{{ route('admin.profile.remove-avatar', $admin->id) }}"
                      method="POST"
                      id="removeAvatarForm"
                      style="display:none;">
                    @csrf
        ...
        <div class="settings-panel">
            ...
            <div class="tab-content active" id="tab-profile">
                ...
                <form action="{{ route('admin.profile.update', $admin->id ?? 0) }}" method="POST">
                    @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="civil_status"
                                    ...
                                    @foreach(['Single','Married','Widowed','Separated'] as $cs)
                                        <option value="{{ $cs }}"
                                            {{ old('civil_status', $admin->civil_status) == $cs ? 'selected' : '' }}>
                                            {{ $cs }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group full-width">
                                ...
                                <textarea name="address" rows="2"
                                          ...
                                          placeholder="Enter your complete address" required>{{ old('address', $admin->address) }}</textarea>
