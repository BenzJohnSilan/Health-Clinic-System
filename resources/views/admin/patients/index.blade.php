...
<div class="container">
    ...
    <form method="GET" action="{{ route('admin.patients.index') }}" class="filter-bar">
        ...
        @if($activeFilters->isNotEmpty())
            <a href="{{ route('admin.patients.index') }}" class="btn-clear-filter">Clear</a>
        @endif
    </form>
                    ...
                    <div class="action-cell">
                        ...
                        <div class="action-menu">
                            ...
                            <div class="action-menu-dropdown">
                                ...
                                <a href="{{ route('admin.patients.appointments', ['type' => $patient['type'], 'id' => $patient['raw_id']]) }}"
...
<div id="appointmentModal" class="modal-overlay" style="display:none;">
    <div class="modal-box">
        ...
        <form method="POST" action="{{ route('admin.patients.appointments.store') }}">
            @csrf
...
@php
    ...
    $patientUpdateUrlTemplate = route('admin.patients.update', ['type' => '__TYPE__', 'id' => '__ID__']);
@endphp
