...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-nav-wrapper">
        ...
        <a href="{{ route('staff.pending-appointments') }}"
           class="{{ request()->routeIs('staff.pending-appointments') ? 'active' : '' }}">
                ...
                <div class="notif-panel" id="notifPanel">
                    ...
                    @if($notificationCount > 0)
                        <div class="notif-panel-footer">
                            <a href="{{ route('staff.pending-appointments') }}" class="notif-view-all">
